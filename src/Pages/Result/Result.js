...
class Result extends Component {
  ...
  render() {
    let { sentencesLearned, isLastSkipped, URLload } = this.state;
            ...
            <div>
              {!isLastSkipped ? (
                ...
                <h4 style={{ cursor: "pointer" }}>
                  you have learned {sentencesLearned} {sentencesLearned > 1 ? "sentences" : "sentence"}!
                </h4>
              )}
              <MDBBtn
                data-tip="Press Enter to find another set to learn."
                outline={true}
                color="warning"
                onClick={() => this.props.history.push("/")}
                style={{ borderRadius: 50 }}
              >
                Did you like it? Start a new set.
              </MDBBtn>
              <h4 style={{ cursor: "pointer" }}>Test your friends!</h4>
              {URLload ? (
